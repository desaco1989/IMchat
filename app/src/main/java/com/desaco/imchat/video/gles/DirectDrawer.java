...
import com.desaco.imchat.MyApplication;
import com.desaco.imchat.R;
import com.desaco.imchat.utils.GlUtil;
import com.desaco.imchat.utils.TextResourceReader;
...
public class DirectDrawer {
    ...
    public DirectDrawer(int texture) {
        ...
        if (texture == 1) {
            fragmentShader = TextResourceReader.readTextFileFromResource(MyApplication.getContext()
